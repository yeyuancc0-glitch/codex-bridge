...
| Local MCP/Tunnel | phases 2/3 | evaluated-local | swift-sdk production contract and listener limits established; implementation not started | `docs/MCP_SWIFT_SDK_INTEGRATION.md` | local 0.12.1 source audit | NIO adapter, Inspector, ChatGPT and helper regression pending |
