...
public enum CodexApprovalWireDecoder {
  ...
  private static func decodePlanUpdate(
  ...
  private static func decodeCompletedCommand(
  ...
  private static func decodeCompletedFileChange(
    params: [String: JSONValue],
    item: [String: JSONValue]
  ...
  private static func completedItemReference(
    params: [String: JSONValue],
    item: [String: JSONValue]
  ...
  private static func optionalInt32(
    _ object: [String: JSONValue],
    key: String
  ) throws -> Int32? {
    guard let value = object[key], value != .null else { return nil }
