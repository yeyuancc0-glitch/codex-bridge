...
public struct MCPServiceServerFactory: Sendable {
  ...
  package static func instructions(customInstructions: String) -> String {
    let base =
      ...
      + "shared by Codex, OpenCode, DeepSeek Harness, and Antigravity. Native ACP Plan/read-only "
      + "or Build/workspace-write follows that default for OpenCode. A read-only value may always "
      + "narrow it; selecting workspace-write requires permission_mode_override=true. Network access follows native "
