...
> Development status: pre-release. The repository contains tested domain, persistence, security, project/file, policy, Codex protocol/runtime, MCP, Tunnel, reporting, verification and native daily-operation presentation modules. A runnable AppShell, Onboarding, complete execution-to-report composition, real ChatGPT acceptance and release packaging are still in development.
